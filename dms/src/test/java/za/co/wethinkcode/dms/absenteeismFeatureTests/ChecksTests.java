...
public class ChecksTests {
    ...
    void TestCheckInLateTime() {
        CheckIn checkIn = CheckIn.getCheckIn("tetema", LocalTime.parse("14:30"), LocalDate.parse("2022-03-13"));
    ...
    void TestCheckInEarlyTime() {
        CheckIn checkIn = CheckIn.getCheckIn("tetema", LocalTime.parse("08:30"), LocalDate.parse("2022-03-13"));
        assertThat(checkIn).isNotNull();
